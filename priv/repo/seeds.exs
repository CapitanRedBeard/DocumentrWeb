...
Repo.insert! %Parameter{path_id: account2.id, key: "membership_name", value: "foo"}
Repo.insert! %Parameter{path_id: account2.id, key: "name", value: "foo"}
...
Repo.insert! %Parameter{path_id: account3.id, key: "membership_name", value: "foo"}
Repo.insert! %Parameter{path_id: account3.id, key: "name", value: "foo"}
...
Repo.insert! %Parameter{path_id: post2.id, key: "membership_name", value: "foo"}
Repo.insert! %Parameter{path_id: post2.id, key: "name", value: "foo"}

post3 = Repo.insert! %Path{api_id: api.id, url: "/post", description: "Creates a new post", response_type: "application/json", method: "put"}
Repo.insert! %Parameter{path_id: post3.id, key: "membership_name", value: "foo"}
Repo.insert! %Parameter{path_id: post3.id, key: "name", value: "foo"}
...
Repo.insert! %Parameter{path_id: post4.id, key: "post_id", value: "foo"}
...
Repo.insert! %Parameter{path_id: comment2.id, key: "membership_name", value: "foo"}
Repo.insert! %Parameter{path_id: comment2.id, key: "name", value: "foo"}
...
Repo.insert! %Parameter{path_id: comment3.id, key: "membership_name", value: "foo"}
Repo.insert! %Parameter{path_id: comment3.id, key: "name", value: "foo"}
...
Repo.insert! %Parameter{path_id: comment4.id, key: "comment_id", value: "foo"}
